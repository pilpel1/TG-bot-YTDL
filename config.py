...
# Version info
VERSION = "0.8.0"
CHANGELOG = """🆕 גרסה 0.8.0:
🚦 תור הורדות - הבוט כבר לא "קופא" למשתמשים אחרים
• הורדות רצות ברקע בתור סדרתי - הבוט ממשיך להגיב לכולם גם באמצע הורדה ארוכה
• הודעת מיקום בתור + הערכת זמן שמתעדכנת בזמן אמת (לוקחת בחשבון פלייליסטים כבדים יותר)
• אין יותר הודעת "התווסף לתור" מיותרת כשהתור בפועל ריק
• הודעות "מה להוריד?" נשלחות כתגובה (reply) לקישור המקורי, כדי שלא ילכו לאיבוד"""