...
🔍 חיפוש יוטיוב בטקסט חופשי
• שליחת שם שיר, אמן או טקסט קצר (3–100 תווים, עם אותיות) מחפשת ביוטיוב ומציגה תוצאות בכפתורים
• טקסט שלא מתאים לחיפוש, או חיפוש בלי תוצאות — מקבלים את אותה הודעת הסבר כמו קודם
• לחיצה על תוצאה ממשיכה לזרימת ההורדה הרגילה (אודיו/וידאו/איכות)"""
