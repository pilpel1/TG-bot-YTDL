...
🔍 חיפוש יוטיוב בטקסט חופשי (דרך /search_mode)
• /search_mode מפעיל/מכבה מצב חיפוש — כבוי כברירת מחדל
• במצב חיפוש: טקסט חופשי מחפש ביוטיוב (כולל "תודה" כחלק משם שיר)
• מחוץ למצב חיפוש: "תודה" נשארת תגובת תודה כמו קודם
• אם יש קישור בהודעה — תמיד מתייחסים רק אליו (גם עם טקסט מסביב)
• תוצאות החיפוש כוללות כפתור ביטול
• /help במקום /mode — עזרה, פקודות ומגבלת קבצים
• תיאור /search_mode בתפריט טלגרם משקף פעיל/כבוי — פר משתמש
• מצב חיפוש נשמר לדיסק ושורד כיבוי/הפעלה מחדש של הבוט"""
