...
# Version info
VERSION = "0.7.0"
CHANGELOG = """🆕 גרסה 0.7.0:
🎬 שיפור משמעותי בהורדות YouTube
• תיקון בחירת איכות כך שהאיכות שנבחרת באמת משפיעה על ההורדה
• בחירה דינמית של איכויות וידאו עם גודל משוער לכל אפשרות
• סימון איכויות שחסומות בגלל מגבלת גודל + popup הסבר
• הוספת אודיו בלבד לאותה רשימת אפשרויות
• חסימה מוקדמת של קבצים גדולים מדי לפני הורדה כשאפשר לדעת את הגודל
• שיפור timeouts לשליחת קבצים גדולים
• זרימה ייעודית ונוחה יותר לפלייליסטים
