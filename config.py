...
# Version info
VERSION = "0.7.1"
CHANGELOG = """🆕 גרסה 0.7.1:
🎵 הגבלת כמות בהורדת מיקסים ופלייליסטים של YouTube
• שאלה חדשה "כמה להוריד?" למיקס ולפלייליסט, במקום להוריד הכל אוטומטית
• מיקסים: תקרה של 100 סרטונים (אין להם "סוף" אמיתי)
• פלייליסטים רגילים: ספירה מדויקת ואפשרות "כל הפלייליסט" עם המספר המלא
• זיהוי מיקס/פלייליסט גדול קפץ ממתן ~דקה לכמה שניות
• תיקון תמיכה בקישורי watch?v=X&list=Y (הצורה השכיחה שמעתיקים מתוך פלייליסט)
• תיקון race condition שהציג "לא ידוע" בלחיצה מהירה"""